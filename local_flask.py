...
import local_news
from local_news import scrape_legit, scrape_fidelinfo, scrape_kwaralefro, scrape_todayng, scrape_kwaragist, scrape_theinformant247, scrape_fidelinfo, scrape_freshinsight
# (
#                        
#                         )
